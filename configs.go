...
// ReactionConfig contains information about a SendMessage request.
...
func (config ReactionConfig) params() (Params, error) {
	params, err := config.BaseChat.params()
	if err != nil {
		return params, err
	}
	params.AddNonZero("message_id", config.MessageID)
	params.AddBool("is_big", config.Big)
	err = params.AddInterface("reaction", config.Reaction)
	return params, err
}

func (config ReactionConfig) method() string {
